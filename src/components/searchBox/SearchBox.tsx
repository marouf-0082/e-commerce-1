...
function SearchBox({ className }: { className?: string }) {
  ...
  return (
    <div className={`relative w-full lg:w-xs ${className}`}>
      {/* {query && (
        <X
          size={16}
          color="#666666"
      ...
      <input
        ...
        className="w-full rounded-full ring-1 ring-border bg-background py-2.5 pl-11 pr-4 text-foreground text-sm outline-none placeholder:text-foreground-2"
      />
      <div
